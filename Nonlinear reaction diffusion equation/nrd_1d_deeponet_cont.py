...
class TPIDON():
    ...
    def check_with_visual(self):
        ...
        test_tr_evo_error, test_tr_evo_re_error, test_tr_evo_re_error_T, f_tr_pred_tensor, pred_tr_time = self.all_test_tr_result(self.cl)
...
if __name__ == "__main__":
    ...
    filename = 'D_TPIDON_nrd_ct_1d' + '_k_' + num2str_deciaml(k) + '_d_' + num2str_deciaml(
        d) + '_Nx_' + num2str_deciaml(
